        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FormSubmissions_AspNetUsers_SubmittedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileStorages_FormSubmissions_FormSubmissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubmissionValueId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FormSubmissionId = table.Column<int>(type: "int", nullable: false),
                    FormFieldId = table.Column<int>(type: "int", nullable: false),
                    Value = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmissionValues", x => x.SubmissionValueId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileStorages_FormSubmissionId",
                table: "FileStorages",
